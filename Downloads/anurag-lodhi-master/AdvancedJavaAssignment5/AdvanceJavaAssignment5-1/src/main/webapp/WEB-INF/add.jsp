...
<body>
	...
	<div class="container-fluid">
		...
		<br>
			...
			<div class="card" style="border: 0px;">
				<div class="card-body">
					<form action="add" method="POST" id ="my-form">
						...
						<div class="form-group row">
							<label for="bookCode" class="col-sm-2 col-form-label">
								Book Code </label>
							<div class="col-sm-10">
								<input type="number" class="form-control col-sm-6" id="bookCode"
	...
	<script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
		<script type="text/javascript" src="<c:url value='/resources/add.js'/>"></script>
