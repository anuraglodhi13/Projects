...
export class VendorAddComponent implements OnInit{
  ...
  getUser() {
      this.httpClient.get<any>(this.globalConstant.DOMAIN+'ecommerce/user/'+this.authenticationService.getLoggedInUserName()).
      subscribe(
      response => {
  ...
  getBrands() {
    this.httpClient.get<any>(this.globalConstant.DOMAIN+'ecommerce/product/brands').subscribe(
      response => {
  ...
  getCategories() {
    this.httpClient.get<any>(this.globalConstant.DOMAIN+'ecommerce/product/categories').subscribe(
      response => {
  ...
  onSubmit(registerForm : NgForm){
    ...
    if(!productModelNotEmpty && !productModeNotNull) { 
      const addProductModel = new AddProductModel(this.productModel.productName, this.productModel.productDescription,
        ...
        this.httpClient.post<any>(this.globalConstant.DOMAIN+'ecommerce/product/add/'+this.authenticationService.getLoggedInUserName(),this.addProductFormData).subscribe(
          response => {
